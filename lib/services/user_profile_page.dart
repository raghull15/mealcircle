...
import 'package:mealcircle/services/about_us_page.dart';
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    _kAccentOrange.withOpacity(0.2),
                    _kAccentOrange.withOpacity(0.1),
                  ],
                ),
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.verified, color: _kAccentOrange, size: 16),
    ...
    return TweenAnimationBuilder(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: _buildStatCard(
              user?.sheltersHelped.toString() ?? '0',
              'Shelters',
              Icons.home,
              Colors.blue,
            ),
